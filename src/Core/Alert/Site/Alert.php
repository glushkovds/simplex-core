...
namespace Simplex\Core\Alert\Site;
...
class Alert
{
    ...
    {
        if (!self::$isInited) {
            Page::css(Core::webVendorPath() . '/Core/Alert/Site/alert.css');
     ...
     * @param string|false $goto (optional = false) header("location: ".$goto) and exit;
